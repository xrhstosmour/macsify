...
- Your FIRST tool call before any matched action must be `read` on the matching file. Do not reason, plan, type code, or respond until you have read it. Responding before reading is a violation.
